// Custom version of https://github.com/robert-harbison/xterm-for-react
...
export default class Xterm extends React.Component<IProps> {
  ...
  constructor(props: IProps) {
    ...
    this.customKeyEventHandler = this.customKeyEventHandler.bind(this)
  ...
  private customKeyEventHandler(event: KeyboardEvent): boolean {
    if (this.props.customKeyEventHandler)
      return this.props.customKeyEventHandler(event)
    return true
  }
